...
class Vehicle(object):
    ...
    def check_collision(self, other: Union['Vehicle', 'RoadObject']) -> None:
        ...
        if isinstance(other, Vehicle):
            ...
            if self._is_colliding(other):
                ...
                print("Collision between {} and {}".format(self.id, other.id))
            ...
            if self._is_colliding(other):
                ...
                print("Collision between {} and {}".format(self.id, "obstacle"))
        elif isinstance(other, Landmark):
            if self._is_colliding(other):
                other.hit = True
                print("Collision between {} and {}".format(self.id, "landmark"))
    ...
    def one_hot(self, x: int, n: int = 4) -> np.ndarray:
        """
